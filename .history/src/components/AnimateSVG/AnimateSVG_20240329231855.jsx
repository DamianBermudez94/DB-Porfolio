    ...
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100%" height="100%" viewBox="0 0 1600 900" preserveAspectRatio="xMidYMax slice">
      <defs>
        <linearGradient id="bg">
          <stop offset="0%" style={{ stopColor: 'rgba(249, 130, 130, 0.06)' }}></stop>
          <stop offset="50%" style={{ stopColor: 'rgba(53, 0, 0, 0.6)' }}></stop>
          <stop offset="100%" style={{ stopColor: 'rgba(115, 209, 72, 0)' }}></stop>
        </linearGradient>
