...
export const ListadoTrabajos = () => {
  ...
  const openModal = useCallback((id) => {
    console.log(typeof id); // Imprime el tipo del id que pasas a la función
    const proyecto = trabajos.find((trabajo) =>console.log(trabajo.id === id));
    console.log(typeof proyecto.id);
    console.log(proyecto.id);
    console.log(setProyectoSeleccionado(proyecto)); 
    setModalOpen(true);
        ...
        return (
          <div key={trabajo.id} className="card-proyectos">
            <figure
              ...
              onClick={() => console.log(openModal(trabajo.id))}
            >
              <img
