          ...
          <ul>
            <li>
              <p>
                ...
                oportunidades.LLevo más de dos años estudiando/perfeccionandome
                en las tecnologías más demandadas del mercado.
              </p>
            </li>
            <li>
              <p>
                💼 Mi conjunto de habilidades abarca tanto el desarrollo
                front-end como el back-end de aplicaciones web. Trabajo con
                tecnologías como HTML, CSS, JavaScript, y TypeScript, así como
            ...
            <li>
              <p>
                🖥️ Mi portafolio incluye proyectos web de diversa envergadura.
