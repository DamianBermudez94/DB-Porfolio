  ...
  return (
    <section className="home">
      ...
      <section className="article-section__motivos">
        ...
        <article>
          <h3>Creatividad y funcionalidad</h3>
          <p>
        ...
        <article>
          ...
          <p>
            Contratar a un desarrollador web full stack y diseñador web es como
            tener un as bajo la manga para cualquier proyecto digital. Son como
            camaleones digitales: pueden adaptarse a cualquier tecnología o
            plataforma que necesites, sin importar lo que el futuro traiga. En
            un mundo donde las cosas cambian más rápido que el clima, tener a
