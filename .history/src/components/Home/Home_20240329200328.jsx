...
export const Home = () => {
  ...
  return (
    ...
    <article>
        ...
        <p>Como desarrollador web full stack y diseñador web, puedo ofrecer soluciones completas para tus proyectos. Desde el diseño inicial hasta la implementación técnica, estoy equipado para abordar todas las facetas de tu presencia en línea.</p>
    </article>
    <article>
        <h3>2. Creatividad y funcionalidad</h3>
        <p>Me enorgullece combinar habilidades creativas con un sólido conocimiento técnico. Esto significa que no solo obtendrás un diseño visualmente atractivo, sino también una funcionalidad impecable que garantiza una experiencia de usuario excepcional.</p>
    </article>
    <article>
        <h3>3. Compromiso con tu éxito</h3>
        <p>Estoy comprometido a trabajar estrechamente contigo para comprender tus objetivos y hacer que tu visión cobre vida. Mi objetivo es superar tus expectativas y proporcionarte resultados que impulsen el crecimiento y el éxito de tu negocio en línea.</p>
    </article>
</section>
      </section>
    </section>
