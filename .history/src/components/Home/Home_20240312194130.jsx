...
export const Home = () => {
  ...
  const contentAnimation = useSpring({
    ...
    transform: showContent ? 'translateY(0px)' : 'translateY(50px)', // Animación de desplazamiento hacia arriba
    from: { opacity: 0, transform: 'translateY(50px)' }, // Estilo inicial
    delay: 300, // Retraso de la animación
  });
  return (
