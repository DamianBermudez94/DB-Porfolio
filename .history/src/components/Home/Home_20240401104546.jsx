      ...
      <section className="section-me" style={contentAnimation}>
        ...
        >
          ...
          <ul>
            <li>
              <p>
              ¡Hola! Soy un apasionado <strong>Desarrollador Web Full Stack y Diseñador Web</strong> en constante búsqueda de emocionantes oportunidades para seguir expandiendo mis horizontes profesionales. Con más de dos años y medio dedicados a perfeccionarme en las tecnologías más demandadas del mercado, estoy listo para ofrecer soluciones innovadoras y de alta calidad para tus proyectos.
              </p>
            </li>
            <li>
              <p>
