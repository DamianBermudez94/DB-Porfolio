...
export const Home = () => {
  ...
  const [text, setText] = useState("damian");

  useEffect(() => {
    // Actualiza el texto después de un cierto tiempo
    const interval = setInterval(() => {
      setText("Damian Bermudez");
    }, 2000);
          ...
          <div className="container-home">
            <div className="content">
              <div className="content-title__principal">
                <TextScramble
                  text={text}
                  letterSpeed={10} // Velocidad de animación de las letras
                  scrambleSpeed={550} // Velocidad de la animación de scrambling
                />
              </div>
