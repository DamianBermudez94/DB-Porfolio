...
export const Home = () => {
  const words = [
    "{name:Damian Bermudez}",
    "{profesión:Developer Web Full Stack y Diseñador Web}",
    "{localidad:Lobos - Provincia de Buenos Aires - Argentina }",
  ];
      ...
      <section className="section-me" style={contentAnimation}>
        ...
        >
          ...
          <ul>
            ...
            <li>
              <p>
                <span>🖥️</span>Mi conjunto de habilidades abarca tanto el
                desarrollo front-end como el back-end de aplicaciones web.
                Trabajo con tecnologías como HTML, CSS, JavaScript, y
                TypeScript, así como con frameworks como React, Node.js y
                Express. También tengo experiencia en la gestión de bases de
                datos SQL y NoSQL.
              </p>
            </li>
            <li>
