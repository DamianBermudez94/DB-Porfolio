  ...
  return (
    <section className="home">
      ...
      <section className="section-me" style={contentAnimation}>
        ...
        >
          <figure>
            <img src="/image/Developer-Web-Full-Stack.svg" alt="Developer Web Full Stack - Desarrollador Web Full stack - Paginas Web" />
          </figure>
          <p>
            👨‍💻 Soy un Desarrollador Web Full Stack en busca de nuevas
            oportunidades. 💼 Mi conjunto de habilidades abarca tanto el
            ...
            experiencia en la gestión de bases de datos SQL y NoSQL. 🖥️ Mi
            portafolio incluye proyectos web de diversa envergadura. Desde la
