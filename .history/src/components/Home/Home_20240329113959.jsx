      ...
      <section className="section-me" style={contentAnimation}>
        ...
        >
          ...
          <ul>
            <li>
              <p>
                <span>👨‍💻</span>Soy <strong>Developer Web Full Stack</strong> en busca de nuevas oportunidades y poder seguir creciendo
            ...
            <li>
              <p><span>🖥️</span>Mi conjunto de habilidades abarca tanto el desarrollo front-end
