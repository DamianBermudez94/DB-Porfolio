        ...
        <div className="container-card_servicios">
          ...
          <div className="card">
              <div className="card-details">
                ...
                <p className="text-body">  Mi trabajo se basa en el desarrollo de las interfaces de
                    ...
                    vengan desde diferentes puntos de de la App.</p>
              </div>
              <NavLink className="card-button" to="/contacto">Más info</NavLink>
