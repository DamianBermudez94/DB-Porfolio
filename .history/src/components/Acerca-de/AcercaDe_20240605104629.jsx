...
export const AcercaDe = () => {
  ...
  return (
    <section className="section-me" style={contentAnimation} id="sobre-mi">
      ...
      >
        <article>
          ...
          <p>
            Llevo 3 años dedicándome a las tecnologías más demandadas del
            mercado, y estoy listo para ofrecer soluciones innovadoras y de alta
            calidad para tus proyectos.
          </p>
          <p>
            Mi portafolio incluye proyectos web de diversa envergadura, desde la
            creación de sitios web responsivos hasta la optimización del
            rendimiento y la implementación de características interactivas.
          </p>
          <p>
            Recientemente, he estado perfeccionando mis habilidades y realizando
            proyectos en React y Next.js, además de mejorar el diseño para
            garantizar la calidad de mis trabajos.
          </p>
        </article>
