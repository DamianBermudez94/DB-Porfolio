        ...
        <article className="container-skills">
          <div className="skills-3d">
            <div className="list-front">
              <h3>front-end</h3>
              <ul>
                <li className="item-front" style={{ "--i": 0 }}>
                  <div className="skill-item">
                    <TiHtml5 />
                    <p>HTML</p>
                  </div>
                </li>
                <li className="item-front" style={{ "--i": 1 }}>
                  <div className="skill-item">
                    <FaCss3Alt />
                    <p>CSS3</p>
                  </div>
                </li>
                <li className="item-front" style={{ "--i": 2 }}>
                  <div className="skill-item">
                    <IoLogoJavascript />
                    <p>JavaScript</p>
                  </div>
                </li>
                <li className="item-front" style={{ "--i": 3 }}>
                  <div className="skill-item">
                    <SiTypescript />
                    <p>TypeScript</p>
                  </div>
                </li>
                <li className="item-front" style={{ "--i": 4 }}>
                  <div className="skill-item">
                    <FaReact />
                    <p>React js</p>
                  </div>
                </li>
                <li className="item-front" style={{ "--i": 5 }}>
                  <div className="skill-item">
                    <FaFigma />
                    <p>Figma</p>
                  </div>
            ...
            <h3>Back-end</h3>
              <ul>
                <li className="item-back" style={{ "--i": 0 }}>
                  <div className="skill-item">
                    <FaNode style={"color:red"}/>
                    <p>Node js</p>
                  </div>
                </li>
                <li className="item-back" style={{ "--i": 1 }}>
                  <div className="skill-item">
                    <SiExpress />
                    <p>Express</p>
                  </div>
                ...
                <li className="item-back" style={{ "--i": 2 }}>
                  <div className="skill-item">
                    <IoLogoFirebase />
                    <p>Firebase</p>
                  </div>
                </li>
                <li className="item-back" style={{ "--i": 3 }}>
                  <div className="skill-item">
                    <SiMongodb />
                    <p>Mongo</p>
                  </div>
                </li>
                <li className="item-back" style={{ "--i": 4 }}>
                  <div className="skill-item">
                    <FaGithub />
                    <p>Git Hub</p>
                  </div>
                </li>
                <li className="item-back" style={{ "--i": 5 }}>
                  <div className="skill-item">
                    <BsTerminalFill />
                    <p>Git Bash</p>
                  </div>
                ...
                <li className="item-back" style={{ "--i": 6 }}>
                  <div className="skill-item">
                    <SiPostman />
                    <p>Postman</p>
                  </div>
                </li>
                <li className="item-back" style={{ "--i": 7 }}>
                  <div className="skill-item">
                    <RxVercelLogo />
                    <p>Vercel</p>
                  </div>
                </li>
                <li className="item-back" style={{ "--i": 8 }}>
                  <div className="skill-item">
                    <GrHeroku />
                    <p>Heroku</p>
                  </div>
