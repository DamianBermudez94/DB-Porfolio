          ...
          <div className="skills-3d">
            ...
            <div  className="list-back">
              <ul>
                ...
                <li className="item-back" style={{ "--i": 9 }}>
                  <div className="skill-item">
                    <SiMongodb />
                    <p>Mongo</p>
                  </div>
                </li>
                <li className="item-back" style={{ "--i": 10 }}>
                  <div className="skill-item">
                    <FaGithub />
                    <p>Git Hub</p>
                  </div>
                </li>
                <li className="item-back" style={{ "--i": 11 }}>
                  <div className="skill-item">
                    <BsTerminalFill />
                    <p>Git Bash</p>
                  </div>
                ...
                <li className="item-back" style={{ "--i": 12 }}>
                  <div className="skill-item">
                    <SiPostman />
                    <p>Postman</p>
                  </div>
                </li>
                <li className="item-back" style={{ "--i": 13 }}>
                  <div className="skill-item">
                    <RxVercelLogo />
                    <p>Vercel</p>
                  </div>
                </li>
                <li className="item-back" style={{ "--i": 14 }}>
                  <div className="skill-item">
                    <GrHeroku />
                    <p>Heroku</p>
                  </div>
