...
export const Service = () => {
  ...
  useEffect(() => {
    ...
    const handleTouchMove = () => {
      handleScroll(); // Llamamos a la misma lógica que en handleScroll
    };
    ...
    <section className="section-servicios scroll-effect" id="mis-servicios">
      ...
      <div  className="container-card_servicios">
        <article
          ...
          className={`card ${isVisible[0] ? "visible" : "hidden"} scroll-reveal-izquierda`}
        ...
        <article
         ...
         className={`card ${isVisible[1] ? "visible" : "hidden"} scroll-reveal-derecha`}
        >
          <div className="card-details">
        ...
        className={`card ${isVisible[2] ? "visible" : "hidden"} scroll-reveal-izquierda`}
        ...
        className={`card ${isVisible[3] ? "visible" : "hidden"} scroll-reveal-derecha`}
        >
          <div className="card-details">
            <img
        ...
        className={`card ${isVisible[4] ? "visible" : "hidden"} scroll-reveal-izquierda`}
        >
          <div className="card-details">
            <img
        ...
        <article
        ref={(ref) => { cardRefs.current[5] = ref; }}
        className={`card ${isVisible[5] ? "visible" : "hidden"} scroll-reveal-derecha`}
        >
          <div className="card-details">
