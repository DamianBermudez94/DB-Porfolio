      ...
      <div className="container-card_servicios">
          ...
          <div className="card-details">
            ...
            <ul>
              <li>
                <p>
                  {" "}
                  1-Diseño de interfaces de usuario modernas y atractivas que se
              ...
              <li>
                <p>
                  2-Desarrollo de experiencias de usuario intuitivas y fluidas
              ...
              <li>
                <p>
                  {" "}
                  3-Optimización para dispositivos móviles y diferentes tamaños
                  de pantalla, garantizando que el sitio sea accesible y
              ...
              <li>
                <p>
                  {" "}
                  4-Implementación de animaciones y efectos interactivos para
              ...
              <li>
                <p>
                  {" "}
                  5-Integración de frameworks y librerías front-end como React
        ...
        >
          <div className="card-details">
            ...
            <ul>
              <li>
                <p>Desarrollo de sitios web responsive, compatibles con dispositivos móviles, para garantizar una experiencia óptima en cualquier pantalla.</p>
              </li>
              <li>
                <p>Diseño centrado en el usuario que refleja la identidad y valores de la marca, generando confianza y credibilidad.</p>
              </li>
              <li>
                <p>Funcionalidades personalizadas y escalables según las necesidades del cliente, desde blogs y galerías de productos hasta integraciones con redes sociales.</p>
              </li>
              <li>
                <p>Optimización del rendimiento y la velocidad de carga para mejorar el posicionamiento SEO y la satisfacción del usuario.</p>
              </li>
              <li>
                <p>Mantenimiento y soporte continuo para garantizar la seguridad y el funcionamiento óptimo del sitio a lo largo del tiempo.</p>
              </li>
            </ul>
          </div>
          <NavLink className="card-button" to="/contacto">
