    ...
    <section className="section-servicios scroll-effect" id="mis-servicios">
      ...
      <div className="container-card_servicios">
        <article
          ...
          className={`card ${
            isVisible[0] ? "visible" : "hidden"
          } scroll-reveal-izquierda`}
        >
        ...
        <article
          ...
          className={`card ${
            isVisible[1] ? "visible" : "hidden"
          } scroll-reveal-derecha`}
        >
          <div className="card-details">
        ...
        <article
          ref={(ref) => {
            cardRefs.current[2] = ref;
          }}
          className={`card ${
            isVisible[2] ? "visible" : "hidden"
          } scroll-reveal-izquierda`}
        >
          <div className="card-details">
        ...
        <article
          ref={(ref) => {
            cardRefs.current[3] = ref;
          }}
          className={`card ${
            isVisible[3] ? "visible" : "hidden"
          } scroll-reveal-derecha`}
        >
          <div className="card-details">
            <img
        ...
        <article
          ref={(ref) => {
            cardRefs.current[4] = ref;
          }}
          className={`card ${
            isVisible[4] ? "visible" : "hidden"
          } scroll-reveal-izquierda`}
        >
          <div className="card-details">
            <img
        ...
        <article
          ref={(ref) => {
            cardRefs.current[5] = ref;
          }}
          className={`card ${
            isVisible[5] ? "visible" : "hidden"
          } scroll-reveal-derecha`}
        >
          <div className="card-details">
