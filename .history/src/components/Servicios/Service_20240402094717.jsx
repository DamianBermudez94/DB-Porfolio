        ...
        >
          <div className="card-details">
            ...
            <p className="text-body">
              ...
              del cliente. 2-Desarrollo de experiencias de usuario intuitivas y
              fluidas mediante el uso de tecnologías como HTML5, CSS3 y
              JavaScript, asegurando una navegación fácil y agradable.
              3-Optimización para dispositivos móviles y diferentes tamaños de
              pantalla, garantizando que el sitio sea accesible y funcional en
              cualquier dispositivo. 4-Implementación de animaciones y efectos
              interactivos para mejorar la interactividad y el atractivo visual
              del sitio. 5-Integración de frameworks y librerías front-end como
