      ...
      <div className="container-card_servicios">
        ...
        >
          <div className="card-details">
            ...
            <ul>
              <li>
                <p>Desarrollo de tiendas online seguras y fáciles de usar, con sistemas de pago integrados para facilitar las transacciones.</p>
              </li>
              <li>
                <p>Diseño de interfaces intuitivas que guíen al usuario a través del proceso de compra, minimizando los pasos necesarios.</p>
              </li>
              <li>
                <p>Personalización de la experiencia de compra mediante recomendaciones de productos, ofertas especiales y funciones de seguimiento de pedidos.</p>
              </li>
              <li>
                <p>Implementación de herramientas de análisis y seguimiento para entender el comportamiento del usuario y optimizar la conversión.</p>
              </li>
              <li>
                <p>Integración con plataformas de marketing digital y redes sociales para impulsar el tráfico y las ventas.</p>
              </li>
            </ul>
          </div>
          <NavLink className="card-button" to="/contacto">
