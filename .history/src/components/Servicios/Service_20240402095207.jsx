      ...
      <div className="container-card_servicios">
        ...
        >
          <div className="card-details">
            ...
            <ul>
              <li>
                <p>Diseño atractivo y personalizado que captura la atención del visitante desde el primer momento.</p>
              </li>
              <li>
                <p>Optimización para una experiencia de usuario intuitiva y de carga rápida, maximizando las conversiones.</p>
              </li>
              <li>
                <p>Uso de elementos persuasivos como llamadas a la acción (CTA) claras y botones de contacto que incitan a la interacción.</p>
              </li>
              <li>
                <p>Integración de formularios de contacto y captura de leads para facilitar el seguimiento y la generación de clientes potenciales.</p>
              </li>
              <li>
                <p>Implementación de técnicas de SEO on-page para mejorar la visibilidad y el posicionamiento en los motores de búsqueda.</p>
              </li>
            </ul>
          </div>
          <NavLink className="card-button" to="/contacto">
