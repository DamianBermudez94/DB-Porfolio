        ...
        >
          <div className="card-details">
            ...
            <ul>
              ...
              <li>
                <p>Implementación de bases de datos eficientes y fiables (SQL o NoSQL) para gestionar datos de manera efectiva y garantizar un rendimiento óptimo del sitio.</p>
              </li>
              <li>
                <p>Creación de APIs RESTful para facilitar la comunicación entre el front end y el back end, permitiendo una interacción dinámica y fluida.</p>
              </li>
              <li>
                <p>Implementación de sistemas de autenticación y autorización robustos para proteger los datos sensibles y garantizar la seguridad del sitio.</p>
              </li>
              <li>
                <p>Optimización del rendimiento del servidor y de las consultas a la base de datos para mejorar la velocidad de carga y la experiencia del usuario.</p>
              </li>
            </ul>
          </div>
          <NavLink className="card-button" to="/contacto">
