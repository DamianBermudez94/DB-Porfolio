      ...
      <div className="container-card_servicios">
        ...
        >
          <div className="card-details">
            ...
            <ul>
              <li>
                <p>Creación de diseños visualmente atractivos y coherentes que reflejen la marca y cautiven al público objetivo.</p>
              </li>
              <li>
                <p>Utilización de principios de diseño UX/UI para garantizar una navegación intuitiva y una experiencia de usuario satisfactoria.</p>
              </li>
              <li>
                <p>Integración de elementos multimedia y contenido interactivo para enriquecer la experiencia del usuario.</p>
              </li>
              <li>
                <p>Enfoque en la accesibilidad web y la usabilidad para garantizar que el sitio sea inclusivo y accesible para todos los usuarios.</p>
              </li>
              <li>
                <p>Colaboración estrecha con el cliente para entender sus necesidades y objetivos, y ofrecer soluciones creativas y efectivas.</p>
              </li>
            </ul>
          </div>
          <NavLink className="card-button" to="/contacto">
